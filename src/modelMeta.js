export const MODEL_META = {
  'gpt-5.4-mini': { displayName: 'GPT 5.4 Mini', description: 'GPT 5.4 Mini via Ergo API', inputModalities: ['text'] },
  'gpt-5.4': { displayName: 'GPT 5.4', description: 'GPT 5.4 via Ergo API', inputModalities: ['text'] },
  'gpt-5.5': { displayName: 'GPT 5.5', description: 'GPT 5.5 via Ergo API', inputModalities: ['text'] },
  'gpt-5.6-terra': { displayName: 'GPT 5.6 Terra', description: 'GPT 5.6 Terra via Ergo API', inputModalities: ['text'] },
  'gpt-5.6-luna': { displayName: 'GPT 5.6 Luna', description: 'GPT 5.6 Luna via Ergo API', inputModalities: ['text', 'image'] },
  'gpt-5.6-sol': { displayName: 'GPT 5.6 Sol', description: 'GPT 5.6 Sol via Ergo API', inputModalities: ['text'] },
